...
ifeq ($(wildcard third_party/boringssl-with-bazel/include/openssl/ssl.h),)
...
CPPFLAGS := -Ithird_party/boringssl-with-bazel/include $(CPPFLAGS)  
...
$(LIBBORINGSSL_OBJS): CPPFLAGS += -Ithird_party/boringssl-with-bazel/include -fvisibility=hidden -DOPENSSL_NO_ASM -D_GNU_SOURCE -DWIN32_LEAN_AND_MEAN -D_HAS_EXCEPTIONS=0 -DNOMINMAX
