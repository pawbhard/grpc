...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc/context_types.h )
  ...
  s.files += %w( include/grpc/private_key_signer.h )
  ...
  s.files += %w( src/core/credentials/transport/tls/grpc_tls_certificate_selector.cc )
  ...
  s.files += %w( src/core/ext/upb-gen/envoy/config/common/mutation_rules/v3/mutation_rules.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/config/common/mutation_rules/v3/mutation_rules.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/config/common/mutation_rules/v3/mutation_rules.upb_minitable.h )
  ...
  s.files += %w( src/core/ext/upb-gen/envoy/config/core/v3/cel.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/config/core/v3/cel.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/config/core/v3/cel.upb_minitable.h )
  ...
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/common/matching/v3/extension_matcher.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/common/matching/v3/extension_matcher.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/common/matching/v3/extension_matcher.upb_minitable.h )
  ...
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/common/matcher/action/v3/skip_action.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/common/matcher/action/v3/skip_action.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/common/matcher/action/v3/skip_action.upb_minitable.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/composite/v3/composite.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/composite/v3/composite.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/composite/v3/composite.upb_minitable.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/ext_proc.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/ext_proc.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/ext_proc.upb_minitable.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/processing_mode.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/processing_mode.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/extensions/filters/http/ext_proc/v3/processing_mode.upb_minitable.h )
  ...
  s.files += %w( src/core/ext/upb-gen/envoy/service/ext_proc/v3/external_processor.upb.h )
  s.files += %w( src/core/ext/upb-gen/envoy/service/ext_proc/v3/external_processor.upb_minitable.c )
  s.files += %w( src/core/ext/upb-gen/envoy/service/ext_proc/v3/external_processor.upb_minitable.h )
  ...
  s.files += %w( src/core/ext/upbdefs-gen/envoy/config/common/mutation_rules/v3/mutation_rules.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/config/common/mutation_rules/v3/mutation_rules.upbdefs.h )
  ...
  s.files += %w( src/core/ext/upbdefs-gen/envoy/config/core/v3/cel.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/config/core/v3/cel.upbdefs.h )
  ...
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/common/matching/v3/extension_matcher.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/common/matching/v3/extension_matcher.upbdefs.h )
  ...
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/common/matcher/action/v3/skip_action.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/common/matcher/action/v3/skip_action.upbdefs.h )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/composite/v3/composite.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/composite/v3/composite.upbdefs.h )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/ext_proc/v3/ext_proc.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/ext_proc/v3/ext_proc.upbdefs.h )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/ext_proc/v3/processing_mode.upbdefs.c )
  s.files += %w( src/core/ext/upbdefs-gen/envoy/extensions/filters/http/ext_proc/v3/processing_mode.upbdefs.h )
  ...
  s.files += %w( src/core/filter/composite/composite_filter.cc )
  s.files += %w( src/core/filter/composite/composite_filter.h )
  s.files += %w( src/core/filter/ext_proc/ext_proc_filter.cc )
  s.files += %w( src/core/filter/ext_proc/ext_proc_filter.h )
  s.files += %w( src/core/filter/ext_proc/ext_proc_messages.cc )
  s.files += %w( src/core/filter/ext_proc/ext_proc_messages.h )
  ...
  s.files += %w( src/core/load_balancing/autosharding/autoshard.cc )
  s.files += %w( src/core/load_balancing/autosharding/autoshard.h )
  ...
  s.files += %w( src/core/load_balancing/weighted_round_robin/weighted_round_robin.h )
  ...
  s.files += %w( src/core/mitigation_engine/mitigation.h )
  s.files += %w( src/core/mitigation_engine/mitigation_engine.h )
  s.files += %w( src/core/mitigation_engine/mitigation_provider.h )
  ...
  s.files += %w( src/core/xds/grpc/blackboard.cc )
  s.files += %w( src/core/xds/grpc/blackboard.h )
  ...
  s.files += %w( src/core/xds/grpc/xds_bootstrap_grpc_builder.cc )
  s.files += %w( src/core/xds/grpc/xds_bootstrap_grpc_builder.h )
  ...
  s.files += %w( src/core/xds/grpc/xds_grpc_service_parser.cc )
  s.files += %w( src/core/xds/grpc/xds_grpc_service_parser.h )
  s.files += %w( src/core/xds/grpc/xds_health_status.cc )
  s.files += %w( src/core/xds/grpc/xds_health_status.h )
  s.files += %w( src/core/xds/grpc/xds_http_composite_filter.cc )
  s.files += %w( src/core/xds/grpc/xds_http_composite_filter.h )
  s.files += %w( src/core/xds/grpc/xds_http_ext_proc_filter.cc )
  s.files += %w( src/core/xds/grpc/xds_http_ext_proc_filter.h )
  ...
  s.files += %w( src/core/xds/grpc/xds_tls_context.cc )
  s.files += %w( src/core/xds/grpc/xds_tls_context.h )
  s.files += %w( src/core/xds/grpc/xds_tls_context_parser.cc )
  s.files += %w( src/core/xds/grpc/xds_tls_context_parser.h )
  ...
  s.files += %w( third_party/boringssl-with-bazel/crypto/aes/aes.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_bitstr.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_bool.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_d2i_fp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_dup.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_gentm.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_i2d_fp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_int.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_mbstr.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_object.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_octet.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_strex.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_strnid.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_time.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_type.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/a_utctm.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/asn1_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/asn1_par.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/asn_pack.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/f_int.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/f_string.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/posix_time.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_dec.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_enc.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_fre.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_new.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_typ.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/asn1/tasn_utl.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/base64/base64.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bcm_support.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/bio.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/bio_mem.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/connect.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/errno.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/fd.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/file.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/hexdump.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/pair.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/printf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/socket.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bio/socket_helper.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/blake2/blake2.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bn/bn_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bn/convert.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bn/exponentiation.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/buf/buf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/asn1_compat.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/ber.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/cbb.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/cbs.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/bytestring/unicode.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/chacha/chacha.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/chacha/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/derive_key.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_aesctrhmac.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_aeseax.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_aesgcmsiv.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_chacha20poly1305.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_des.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_null.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_rc2.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_rc4.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/e_tls.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/get_cipher.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cipher/tls_cbc.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cms/cms.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/conf/conf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/conf/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_apple.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_fuchsia.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_linux.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_openbsd.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_sysreg.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_aarch64_win.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_arm_freebsd.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_arm_linux.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_arm_linux.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/cpu_intel.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/crypto.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/curve25519/curve25519.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/curve25519/curve25519_64_adx.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/curve25519/curve25519_tables.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/curve25519/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/curve25519/spake25519.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/des/des.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/des/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/dh/dh_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/dh/params.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/digest/digest_extra.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/dsa/dsa.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/dsa/dsa_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/dsa/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ec/ec_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ec/ec_derive.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ec/hash_to_curve.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ec/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ecdh/ecdh.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ecdsa/ecdsa_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/engine/engine.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/err/err.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/err/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/evp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/evp_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/evp_ctx.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_dh.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_dh_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_dsa_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_ec.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_ec_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_ed25519.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_ed25519_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_hkdf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_rsa.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_rsa_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_x25519.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/p_x25519_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/pbkdf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/print.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/scrypt.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/evp/sign.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/ex_data.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/aes.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/aes_nohw.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/cbc.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/cfb.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/ctr.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/gcm.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/gcm_nohw.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/aes/internal.h )
  ...
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/bn.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/bytes.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/cmp.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/ctx.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/div.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/div_extra.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/exponentiation.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/gcd.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/gcd_extra.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/generic.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/jacobi.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/montgomery.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/montgomery_inv.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/mul.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/prime.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/random.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/rsaz_exp.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/rsaz_exp.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/shift.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/bn/sqrt.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cipher/aead.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cipher/cipher.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cipher/e_aes.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cipher/e_aesccm.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cipher/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/cmac/cmac.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/delocate.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/dh/check.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/dh/dh.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/dh/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/digest/digest.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/digest/digests.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/digest/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/digest/md32_common.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/digestsign/digestsign.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/builtin_curves.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/ec.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/ec_key.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/ec_montgomery.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/felem.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/oct.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p224-64.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p256-nistz-table.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p256-nistz.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p256-nistz.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p256.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/p256_table.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/scalar.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/simple.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/simple_mul.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/util.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ec/wnaf.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ecdh/ecdh.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ecdsa/ecdsa.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/ecdsa/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/fips_shared_support.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/hkdf/hkdf.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/hmac/hmac.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/keccak/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/keccak/keccak.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/mldsa/fips_known_values.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/mldsa/mldsa.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/mlkem/fips_known_values.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/mlkem/mlkem.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rand/ctrdrbg.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rand/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rand/rand.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rsa/blinding.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rsa/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rsa/padding.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rsa/rsa.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/rsa/rsa_impl.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/self_check/fips.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/self_check/self_check.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/service_indicator/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/service_indicator/service_indicator.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/sha/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/sha/sha1.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/sha/sha256.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/sha/sha512.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/address.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/fips_known_values.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/fors.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/fors.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/merkle.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/merkle.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/params.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/slhdsa.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/thash.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/thash.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/wots.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/slhdsa/wots.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/tls/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fipsmodule/tls/kdf.cc.inc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/fuzzer_mode.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/hpke/hpke.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/hrss/hrss.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/hrss/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/kyber/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/kyber/kyber.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/lhash/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/lhash/lhash.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/md4/md4.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/md5/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/md5/md5.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/mem.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/mldsa/mldsa.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/mlkem/mlkem.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/obj/obj.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/obj/obj_dat.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/obj/obj_xref.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_all.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_info.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_oth.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_pk8.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_pkey.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pem/pem_xaux.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs7/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs7/pkcs7.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs7/pkcs7_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs8/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs8/p5_pbev2.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs8/pkcs8.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pkcs8/pkcs8_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/poly1305/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/poly1305/poly1305.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/poly1305/poly1305_arm.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/poly1305/poly1305_vec.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pool/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/pool/pool.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/deterministic.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/fork_detect.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/forkunsafe.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/getentropy.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/getrandom_fillin.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/ios.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/passive.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/rand.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/trusty.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/urandom.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rand/windows.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rc4/rc4.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/refcount.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rsa/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rsa/rsa_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rsa/rsa_crypt.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rsa/rsa_extra.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/rsa/rsa_print.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/sha/sha1.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/sha/sha256.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/sha/sha512.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/siphash/siphash.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/slhdsa/slhdsa.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/spake2plus/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/spake2plus/spake2plus.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/stack/stack.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/thread.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/thread_none.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/thread_pthread.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/thread_win.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/trust_token/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/trust_token/pmbtoken.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/trust_token/trust_token.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/trust_token/voprf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/a_digest.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/a_sign.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/a_verify.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/algorithm.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/asn1_gen.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/by_dir.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/by_file.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/ext_dat.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/i2d_pr.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/name_print.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/policy.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/rsa_pss.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/t_crl.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/t_req.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/t_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/t_x509a.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_akey.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_akeya.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_alt.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_bcons.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_bitst.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_conf.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_cpols.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_crld.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_enum.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_extku.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_genn.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_ia5.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_info.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_int.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_ncons.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_ocsp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_pcons.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_pmaps.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_prn.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_purp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_skey.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/v3_utl.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_att.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_cmp.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_d2.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_def.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_ext.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_lu.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_obj.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_req.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_set.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_trs.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_txt.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_v3.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_vfy.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509_vpm.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509cset.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509name.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509rset.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x509spki.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_algor.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_all.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_attrib.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_crl.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_exten.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_name.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_pubkey.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_req.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_sig.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_spki.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_val.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/crypto/x509/x_x509a.cc )
  s.files += %w( third_party/boringssl-with-bazel/gen/crypto/err_data.cc )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/aead.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/aes.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/arm_arch.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/asm_base.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/asn1.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/asn1_mac.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/asn1t.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/base.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/base64.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/bcm_public.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/bio.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/blake2.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/blowfish.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/bn.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/buf.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/buffer.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/bytestring.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/cast.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/chacha.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/cipher.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/cmac.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/cms.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/conf.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/cpu.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/crypto.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ctrdrbg.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/curve25519.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/des.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/dh.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/digest.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/dsa.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/dtls1.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/e_os2.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ec.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ec_key.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ecdh.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ecdsa.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/engine.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/err.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/evp.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/evp_errors.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ex_data.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/experimental/kyber.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/hkdf.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/hmac.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/hpke.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/hrss.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/is_boringssl.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/kdf.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/lhash.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/md4.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/md5.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/mem.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/mldsa.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/mlkem.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/nid.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/obj.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/obj_mac.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/objects.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/opensslconf.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/opensslv.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ossl_typ.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/pem.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/pkcs12.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/pkcs7.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/pkcs8.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/poly1305.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/pool.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/posix_time.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/rand.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/rc4.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ripemd.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/rsa.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/safestack.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/service_indicator.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/sha.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/siphash.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/slhdsa.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/span.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/srtp.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ssl.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/ssl3.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/stack.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/target.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/thread.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/time.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/tls1.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/trust_token.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/type_check.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/x509.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/x509_vfy.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/x509v3.h )
  s.files += %w( third_party/boringssl-with-bazel/include/openssl/x509v3_errors.h )
  s.files += %w( third_party/boringssl-with-bazel/ssl/bio_ssl.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/d1_both.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/d1_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/d1_pkt.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/d1_srtp.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/dtls_method.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/dtls_record.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/encrypted_client_hello.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/extensions.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/handoff.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/handshake.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/handshake_client.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/handshake_server.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/internal.h )
  s.files += %w( third_party/boringssl-with-bazel/ssl/s3_both.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/s3_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/s3_pkt.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_aead_ctx.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_asn1.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_buffer.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_cert.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_cipher.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_credential.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_file.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_key_share.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_lib.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_privkey.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_session.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_stat.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_transcript.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_versions.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/ssl_x509.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/t1_enc.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls13_both.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls13_client.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls13_enc.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls13_server.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls_method.cc )
  s.files += %w( third_party/boringssl-with-bazel/ssl/tls_record.cc )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/curve25519_32.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/curve25519_64.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/curve25519_64_adx.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/curve25519_64_msvc.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/p256_32.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/p256_64.h )
  s.files += %w( third_party/boringssl-with-bazel/third_party/fiat/p256_64_msvc.h )
  ...
  s.files += %w( third_party/upb/upb/base/error_handler.h )
  ...
  s.files += %w( third_party/upb/upb/mini_table/generated_registry.c )
  s.files += %w( third_party/upb/upb/mini_table/generated_registry.h )
  ...
  s.files += %w( third_party/upb/upb/mini_table/internal/generated_registry.h )
  ...
  s.files += %w( third_party/upb/upb/port/sanitizers.h )
  ...
  s.files += %w( third_party/upb/upb/wire/decode_fast/combinations.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/data.h )
  s.files += %w( third_party/upb/upb/wire/decode_fast/select.c )
  s.files += %w( third_party/upb/upb/wire/decode_fast/select.h )
  ...
  s.files += %w( third_party/upb/upb/wire/internal/decoder.c )
  s.files += %w( third_party/upb/upb/wire/internal/decoder.h )
  s.files += %w( third_party/upb/upb/wire/internal/eps_copy_input_stream.h )
  ...
  s.files += %w( third_party/upb/upb/wire/writer.h )
